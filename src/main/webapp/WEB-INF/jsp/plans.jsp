  ...
  <div class="row">
    <div class="navbar col-sm-4 text-center">
     <ul class="navbar-nav sidemenu">
      <li class="nav-item">
        <a class="nav-link active" href="#"><h2>Favourite Meals</h2> <span class="sr-only">(current)</span></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><h2>Current Plan</h2></a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><h2>Recently Ordered</h2> </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="#"><h2>Order now</h2></a>
      </li>
    </ul> 
    </div>
    <div class="col-sm-8">
